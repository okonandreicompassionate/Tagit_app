...
--
-- For a NEW Supabase project. If yours is already set up, use the standalone
-- fix files instead — re-running everything is what caused the non-immutable
-- error before.
--
...
--   8. 20260908200000_accounts_friends_invites.sql
--   9. 20260908230000_scan_day_column.sql
--   10. 20260908234500_recompute_on_delete.sql
-- ============================================================================
...
-- --------------------------------------------------------------------------
-- 20260908200000_accounts_friends_invites.sql
-- --------------------------------------------------------------------------
...
-- --------------------------------------------------------------------------
-- 20260908230000_scan_day_column.sql
-- --------------------------------------------------------------------------
...
-- --------------------------------------------------------------------------
-- 20260908234500_recompute_on_delete.sql
-- --------------------------------------------------------------------------
